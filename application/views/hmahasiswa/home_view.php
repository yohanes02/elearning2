		...
		<div class="row-fluid span12">
			<div class="quick-actions_homepage">
				<ul class="quick-actions">
					...
					<li class="bg_lg span3"> <a href="hmahasiswa/tugas"> <i class="icon-list-alt"></i> Tugas </a>
					</li>
					<li class="bg_ly span3"> <a href="hmahasiswa/diskusimhs"> <i class="icon-group"></i> Ruang Diskusi </a> </li>
					<li class="bg_lo span3"> <a href="hmahasiswa/absensi"> <i class="icon-trophy"></i> Absensi </a> </li>
				</ul>
			</div>
		</div>
		<!--End-Action boxes-->
