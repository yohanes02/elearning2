...
<li class="active"><a href="hmahasiswa/diskusimhs"><i class="icon icon-group"></i> <span>Materi & Forum Diskusi</span></a> </li>
...
<div id="content">
	...
	<hr>
	<input type="hidden" id="prodimhs" name="prodimhs" value="<?php echo $this->session->userdata('ses_prodi');?>">
	<input type="hidden" id="smtmhs" name="smtmhs" value="<?php echo $this->session->userdata('ses_semester');?>">
	<div id="parentmateri"></div>
