...
<li class="active"><a href="hdosen"><i class="icon icon-user"></i> <span>Manage Dosen</span></a> </li>
...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a
				href="dosen" class="current">Dosen</a> </div>
	...
	<div class="container-fluid">
		<div class="ini"></div>
		<!-- modal -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-dosen">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Form <span id="mode"></span> Dosen</h3>
					</div>
					<div class="modal-body">
						<form class="form-horizontal" action="">
							<div class="control-group">
								<label class="control-label" for="iddosen">ID Dosen</label>
								<div class="controls">
									<input type="number" id="iddosen" name="iddosen" class="form-control">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="namadosen">Nama</label>
								<div class="controls">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form name="form2" enctype="multipart/form-data">
							<input type="hidden" name="iddosen1" id="iddosen1">
							<div class="form-group">
								<label for="title">Foto (Choose .jpg file)</label>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
						<h5>Data Dosen Pembelajaran Online</h5>
					</div>
