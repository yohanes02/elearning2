		...
		<div class="row-fluid span12">
			<div class="quick-actions_homepage">
				<ul class="quick-actions">
					<li class="bg_lo span3"> <a href="dosen/buattugas"> <i class="icon-book"></i> Buat Tugas</a> </li>
					<li class="bg_lg span3"> <a href="dosen/subuploadmateri"> <i class="icon-upload-alt"></i> Upload Materi</a>
					</li>
					<li class="bg_ly span3"> <a href="dosen/subbuatdiskusi"> <i class="icon-group"></i> Buat Diskusi </a> </li>
